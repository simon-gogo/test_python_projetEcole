...
st.markdown("""
### Comment relier les consommations énergétiques de certains secteurs des communes de l’Oise 
...
st.info("💬 Ces étapes serviront de base pour développer le modèle prédictif des consommations énergétiques.")
